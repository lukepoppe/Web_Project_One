...
myApp.config(['$routeProvider', function($routeProvider){
    $routeProvider.
        ...
        when('/headBarTwo',{
            templateUrl: "/views/headBarTwo.html",
            controller: 'HeadBarTwoController'
        }).
        otherwise({
            redirectTo: '/home'
        });
...
//////////////////////////////////////
myApp.controller('productReviews', ['$scope', '$http', function($scope, $http){
    ...
    $scope.sendReview = function(review) {
        console.log("Review Object before sent: ",review);
        $http.post('/reviews/addReviews', review).
            success(function(data) {
                $scope.getReviews();
